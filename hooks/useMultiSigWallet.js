...
const contractAddress = "0x44746F3f7D503f840CbB2e6Ef82FB0d75EFa9A53";
...
const useMultiSigWallet = () => {
  ...
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    if (chainId !== 280) {
      window.alert("Change the network to zk-sync Testnet");
      throw new Error("Change network to zk-sync Testnet");
    }
    if (needSigner) {
